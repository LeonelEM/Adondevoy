...
function crearHTMLCardPublicacion($title, $description, $imagen, $id_pub, $pub_usuario = false, $es_favorito = false){
?>	
  ...
  <div class="col-md-3 mb-4 text-center d-flex align-items-stretch">
	...
	<div class="card">
        ...
        <?php
            if ( !$pub_usuario ) {
                ...
                if ( $es_favorito ){
                    ...
                    $link .= "&a=del&id=" . $id_pub .'">' . '<img src=" resources/images/favorito.png' . '"></a>';

                    echo $link;
                }
                else{
                    echo '<a class="nav-link p-0 m-2 text-right" href="index.php?m=fav&a=add&id=' . $id_pub .'">' . '<img src="resources/images/no_favorito.png' . '"></a>';
                }
                
                echo '<a class="nav-link" href="index.php?m=post&id=' . $id_pub .'">';
	    ...
	    <img class="card-img-top"  alt=""  src=" 'resources/images/' .<?php $imagen ?>">
	    ...
	    <div class="card-img-top card-body">
	      ...
	      <div class="card-footer">
              ...
              <div class="row py-2 mt-2 bg-light">
                ...
                <div class="col-12 ">
                    <a class="btn px-4 btn-success" href="index.php?m=post-index&a=edit&id=<?=$id_pub?>" >Editar</a>
                    <a class="btn px-4 btn-danger" href="index.php?m=post-index&a=del&id=<?=$id_pub?>" >Eliminar</a>
                </div>
...
function getOptionsComboCategorias($incluir_cat_todas = false, $id_item_seleccionado = null){
    ...
    include_once  'modelo/DAOs/categoriesDAO.php';
...
function getOptionsComboTiposPublicacion($incluir_opcion_todos = false, $id_item_seleccionado = null){
    ...
    include_once 'modelo/DAOs/post_typesDAO.php';
    ...
    if ($incluir_opcion_todos){
        $opcionesCombo .= '<option value="0">Todas</option>';
    }
