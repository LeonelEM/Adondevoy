...
if ( isset($_REQUEST["a"]) ){
  ...
  switch ( $_REQUEST["a"] ){
    ...
    case "add":
      ...
      $publicacion["title"] = $_POST["titulo"];
    ...
    case "new":
      ...
      include "form_post-edit.inc.php";    

      break;

    case "list":

      include "list_user-posts.inc.php"; 
    ...
    case "del":
        ...
        header( "Location: index.php?m=post-index&a=list&s=" . urlencode("Se ha eliminado la publicacion.") . "&t=success");
      ...
      if (isset($_FILES['imagen']) && $_FILES['imagen']['error'] === UPLOAD_ERR_OK) {
          ...
          if (in_array($fileExtension, $allowedfileExtensions)) {
            ...
            if(move_uploaded_file($fileTmpPath, $dest_path))
            {
              ...
              header( "Location: index.php?m=post-index&a=list&s=" . urlencode($mensaje_ok) . "&t=success");
            }
            else
            {
              ...
              if ( $esModificacion ){
                  ...
                  header( "Location: index.php?m=post-index&a=list&s=" . urlencode("Modificado correctamente.") . "&t=success");
              }
        }
